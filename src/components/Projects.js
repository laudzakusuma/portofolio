...
const projectData = [
  { title: 'TriUnity', description: 'Triunity is a next-generation blockchain architecture conceptually designed to holistically solve the long-standing Blockchain Trilemma.', tags: ['Rust'], githubUrl: 'https://github.com/laudzakusuma/TriUnity.git', liveUrl: 'https://triunity.vercel.app/' },
